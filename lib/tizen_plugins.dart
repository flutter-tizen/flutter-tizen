...
Future<void> _writeAppDepndencyInfo(
  ...
  final tizenProject = TizenProject.fromFlutter(project);
  // Clean up the file generated by older versions, which was named with a
  // leading dot and is no longer ignored by .gitignore.
  final File oldAppDepsJson = tizenProject.hostAppRoot.childFile('.app.deps.json');
  if (oldAppDepsJson.existsSync()) {
    oldAppDepsJson.deleteSync();
  }

  ...
  testUsingContext('--force discards uncommitted changes in the vendored Flutter SDK', () async {
    ...
    processManager.addCommands(<FakeCommand>[
      ...
      const FakeCommand(
        ...
        stdout: ' M packages/flutter_tools/lib/src/cache.dart',
      ),
      const FakeCommand(
    ...
    await createRunner(runLauncher: (List<String> args) async => 0)
        .run(force: true, testFlow: false, verifyOnly: false);
    expect(processManager, hasNoRemainingExpectations);
  }, overrides: <Type, Generator>{
